# 🚀 Demo-kahve - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demo-kahve.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.Demo-kahve.Docker.sln
  ```
...
**Demo-kahve** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
demo-kahve/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.Demo-kahve.Gateway/
      QuickCode.Demo-kahve.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demo-kahve)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demo-kahve-gateway.quickcode.net](https://demo-kahve-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demo-kahve-portal.quickcode.net](https://demo-kahve-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demo-kahve-gateway.quickcode.net](https://demo-kahve-gateway.quickcode.net)
- **Portal:**
    - link: [https://demo-kahve-portal.quickcode.net](https://demo-kahve-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demo-kahve-identity-module.quickcode.net](https://demo-kahve-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demo-kahve-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demo-kahve-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-02-10 22:19:44 UTC]