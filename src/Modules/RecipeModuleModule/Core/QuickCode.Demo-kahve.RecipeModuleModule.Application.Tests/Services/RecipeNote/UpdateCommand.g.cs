...
namespace QuickCode.Demo - kahve . RecipeModuleModule . Application . Tests . Services . RecipeNote {
    public class UpdateRecipeNoteCommandTests : IDisposable
    {
        ...
        public UpdateRecipeNoteCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<RecipeNoteDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<RecipeNoteDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<RecipeNoteDto>()), Times.Never);
        }
