...
namespace QuickCode.Demo - kahve . RecipeModuleModule . Application . Tests . Services . RecipeCategoryAssignment {
    public class UpdateRecipeCategoryAssignmentCommandTests : IDisposable
    {
        ...
        public UpdateRecipeCategoryAssignmentCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            var fakeGetResponse = new RepoResponse<RecipeCategoryAssignmentDto>(fakeDto, "Success");
            var fakeUpdateResponse = new RepoResponse<bool>(true, "Success");
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.Id)).ReturnsAsync(fakeGetResponse);
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<RecipeCategoryAssignmentDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<RecipeCategoryAssignmentDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<RecipeCategoryAssignmentDto>("tr");
            var fakeGetResponse = new RepoResponse<RecipeCategoryAssignmentDto>
            {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<RecipeCategoryAssignmentDto>()), Times.Never);
        }
