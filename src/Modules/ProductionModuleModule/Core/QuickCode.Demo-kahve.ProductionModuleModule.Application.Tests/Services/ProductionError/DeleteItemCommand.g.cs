...
namespace QuickCode.Demo - kahve . ProductionModuleModule . Application . Tests . Services . ProductionError {
    public class ProductionErrorServiceDeleteTests : IDisposable
    {
        ...
        public ProductionErrorServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<ProductionErrorDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ProductionErrorDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ProductionErrorDto>()), Times.Never);
        }
