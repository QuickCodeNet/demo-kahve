...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.KafkaEvent; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . KafkaEvent {
