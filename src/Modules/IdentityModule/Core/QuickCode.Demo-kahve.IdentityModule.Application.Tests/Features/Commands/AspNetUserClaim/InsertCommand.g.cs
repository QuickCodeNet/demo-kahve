...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.AspNetUserClaim; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . AspNetUserClaim {
