...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.AspNetUser; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . AspNetUser {
