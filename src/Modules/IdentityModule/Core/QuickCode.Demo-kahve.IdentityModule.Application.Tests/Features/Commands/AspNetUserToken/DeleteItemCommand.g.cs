...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.AspNetUserToken; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . AspNetUserToken {
