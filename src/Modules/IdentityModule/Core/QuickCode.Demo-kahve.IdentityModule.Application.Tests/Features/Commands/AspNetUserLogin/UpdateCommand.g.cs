...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.AspNetUserLogin; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . AspNetUserLogin {
