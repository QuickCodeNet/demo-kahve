...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.PortalMenu; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . PortalMenu {
