...
using QuickCode.Demo-kahve.IdentityModule.Application.Features.AspNetUserRole; using  QuickCode . Demo
...
-kahve.Common.Models;
namespace QuickCode.Demo - kahve . IdentityModule . Application . Tests . Features . AspNetUserRole {
