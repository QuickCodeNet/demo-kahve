...
using Humanizer;
using QuickCode.Demo-kahve.IdentityModule.Application.Dtos;
using QuickCode.Demo-kahve.IdentityModule.Application.Models;
using QuickCode.Demo-kahve.IdentityModule.Application.Interfaces.Repositories;
using QuickCode.Demo-kahve.Common.Helpers;
using QuickCode.Demo-kahve.Common.Models;

namespace QuickCode.Demo-kahve.IdentityModule.Api.Application.Features.Queries.ApiMethodAccessGrant
{
