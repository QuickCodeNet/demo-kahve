...
using Moq;
using QuickCode.Demo-kahve.IdentityModule.Persistence.Repositories; using  QuickCode . Demo
...
namespace QuickCode.Demo - kahve . IdentityModule . Persistence . Tests . Repositories {
