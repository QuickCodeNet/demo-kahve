...
namespace QuickCode.Demo - kahve . Portal . Models . ProductionModuleModule {
    public class CoffeeBeanData : BaseComboBoxModel
    {
        ...
        public CoffeeBeanDto SelectedItem { get; set; }
        public List<CoffeeBeanDto> List { get; set; }
    }

    public static partial class CoffeeBeanExtensions
    {
        public static string GetKey(this CoffeeBeanDto dto)
        {
            return $"{dto.Id}";
        }
    }
