...
namespace QuickCode.Demo - kahve . Portal . Models . ProductionModuleModule {
    public class RoastingProcessData : BaseComboBoxModel
    {
        ...
        public RoastingProcessDto SelectedItem { get; set; }
        public List<RoastingProcessDto> List { get; set; }
    }

    public static partial class RoastingProcessExtensions
    {
        public static string GetKey(this RoastingProcessDto dto)
        {
            return $"{dto.Id}";
        }
    }
