...
namespace QuickCode.Demo - kahve . Portal . Models . RecipeModuleModule {
    public class RecipeData : BaseComboBoxModel
    {
        ...
        public RecipeDto SelectedItem { get; set; }
        public List<RecipeDto> List { get; set; }
    }

    public static partial class RecipeExtensions
    {
        public static string GetKey(this RecipeDto dto)
        {
            return $"{dto.Id}";
        }
    }
