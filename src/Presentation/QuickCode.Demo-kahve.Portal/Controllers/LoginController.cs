...
using QuickCode.Demo-kahve.Portal.Models;
using LoginRequest = QuickCode.Demo-kahve.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.Demo-kahve.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.Demo-kahve.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
