...
namespace QuickCode.Demo - kahve . Portal . Controllers . RecipeModuleModule {
    [Permission("RecipeModuleModuleRecipeIngredients")]
    [Area("RecipeModuleModule")]
    [Route("RecipeModuleModuleRecipeIngredients")]
    public partial class RecipeIngredientsController : BaseController
    {
        private readonly RecipeModuleModuleContracts.IRecipeIngredientsClient pageClient;
        private readonly RecipeModuleModuleContracts.IRecipesClient pageRecipeClient;
        public RecipeIngredientsController(RecipeModuleModuleContracts.IRecipeIngredientsClient pageClient, RecipeModuleModuleContracts.IRecipesClient pageRecipeClient, IdentityModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List(RecipeIngredientData model)
        {
        ...
        [Route("Insert")]
        [HttpPost]
        public async Task<IActionResult> Insert(RecipeIngredientData model)
        {
            ModelBinder(ref model);
            var result = await pageClient.RecipeIngredientsInsertAsync(model.SelectedItem);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Update")]
        [HttpPost]
        public async Task<IActionResult> Update(RecipeIngredientData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeIngredientsUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete(RecipeIngredientData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeIngredientsDeleteAsync(request.Id);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("InsertItem")]
        public IActionResult InsertItem(RecipeIngredientData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            SetModelBinder(ref model);
        ...
        [Route("DetailItem")]
        public async Task<IActionResult> DetailItem(RecipeIngredientData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("UpdateItem")]
        [HttpPost]
        public async Task<IActionResult> UpdateItem(RecipeIngredientData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("DeleteItem")]
        [HttpPost]
        public async Task<IActionResult> DeleteItem(RecipeIngredientData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
            model.SelectedItem = model.List.Find(i => i.GetKey() == model.SelectedKey);
        ...
        private async Task<RecipeIngredientData> PrepareModel()
        {
            var model = GetModel<RecipeIngredientData>();
            model.CurrentPage = 1;
            model.PageSize = PageSize;
            return await PrepareModel(model);
        }

        private async Task<RecipeIngredientData> PrepareModel(RecipeIngredientData model)
        {
            model.NumberOfRecord = await pageClient.RecipeIngredientsCountAsync();
            model.TotalPage = (model.NumberOfRecord + PageSize - 1) / PageSize;
            model.List = (await pageClient.RecipeIngredientsListAsync(model.CurrentPage, PageSize)).ToList();
            return model;
        }
