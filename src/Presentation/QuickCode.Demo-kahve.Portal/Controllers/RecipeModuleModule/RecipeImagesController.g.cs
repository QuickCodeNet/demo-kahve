...
namespace QuickCode.Demo - kahve . Portal . Controllers . RecipeModuleModule {
    [Permission("RecipeModuleModuleRecipeImages")]
    [Area("RecipeModuleModule")]
    [Route("RecipeModuleModuleRecipeImages")]
    public partial class RecipeImagesController : BaseController
    {
        private readonly RecipeModuleModuleContracts.IRecipeImagesClient pageClient;
        private readonly RecipeModuleModuleContracts.IRecipesClient pageRecipeClient;
        public RecipeImagesController(RecipeModuleModuleContracts.IRecipeImagesClient pageClient, RecipeModuleModuleContracts.IRecipesClient pageRecipeClient, IdentityModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List(RecipeImageData model)
        {
        ...
        [Route("Insert")]
        [HttpPost]
        public async Task<IActionResult> Insert(RecipeImageData model)
        {
            ModelBinder(ref model);
            var result = await pageClient.RecipeImagesInsertAsync(model.SelectedItem);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Update")]
        [HttpPost]
        public async Task<IActionResult> Update(RecipeImageData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeImagesUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete(RecipeImageData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeImagesDeleteAsync(request.Id);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("InsertItem")]
        public IActionResult InsertItem(RecipeImageData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            SetModelBinder(ref model);
        ...
        [Route("DetailItem")]
        public async Task<IActionResult> DetailItem(RecipeImageData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("UpdateItem")]
        [HttpPost]
        public async Task<IActionResult> UpdateItem(RecipeImageData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("DeleteItem")]
        [HttpPost]
        public async Task<IActionResult> DeleteItem(RecipeImageData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
            model.SelectedItem = model.List.Find(i => i.GetKey() == model.SelectedKey);
        ...
        private async Task<RecipeImageData> PrepareModel()
        {
            var model = GetModel<RecipeImageData>();
            model.CurrentPage = 1;
            model.PageSize = PageSize;
            return await PrepareModel(model);
        }

        private async Task<RecipeImageData> PrepareModel(RecipeImageData model)
        {
            model.NumberOfRecord = await pageClient.RecipeImagesCountAsync();
            model.TotalPage = (model.NumberOfRecord + PageSize - 1) / PageSize;
            model.List = (await pageClient.RecipeImagesListAsync(model.CurrentPage, PageSize)).ToList();
            return model;
        }
