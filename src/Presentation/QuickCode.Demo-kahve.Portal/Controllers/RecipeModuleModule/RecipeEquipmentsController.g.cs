...
namespace QuickCode.Demo - kahve . Portal . Controllers . RecipeModuleModule {
    [Permission("RecipeModuleModuleRecipeEquipments")]
    [Area("RecipeModuleModule")]
    [Route("RecipeModuleModuleRecipeEquipments")]
    public partial class RecipeEquipmentsController : BaseController
    {
        private readonly RecipeModuleModuleContracts.IRecipeEquipmentsClient pageClient;
        private readonly RecipeModuleModuleContracts.IRecipesClient pageRecipeClient;
        public RecipeEquipmentsController(RecipeModuleModuleContracts.IRecipeEquipmentsClient pageClient, RecipeModuleModuleContracts.IRecipesClient pageRecipeClient, IdentityModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List(RecipeEquipmentData model)
        {
        ...
        [Route("Insert")]
        [HttpPost]
        public async Task<IActionResult> Insert(RecipeEquipmentData model)
        {
            ModelBinder(ref model);
            var result = await pageClient.RecipeEquipmentsInsertAsync(model.SelectedItem);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Update")]
        [HttpPost]
        public async Task<IActionResult> Update(RecipeEquipmentData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeEquipmentsUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete(RecipeEquipmentData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipeEquipmentsDeleteAsync(request.Id);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("InsertItem")]
        public IActionResult InsertItem(RecipeEquipmentData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            SetModelBinder(ref model);
        ...
        [Route("DetailItem")]
        public async Task<IActionResult> DetailItem(RecipeEquipmentData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("UpdateItem")]
        [HttpPost]
        public async Task<IActionResult> UpdateItem(RecipeEquipmentData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("DeleteItem")]
        [HttpPost]
        public async Task<IActionResult> DeleteItem(RecipeEquipmentData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
            model.SelectedItem = model.List.Find(i => i.GetKey() == model.SelectedKey);
        ...
        private async Task<RecipeEquipmentData> PrepareModel()
        {
            var model = GetModel<RecipeEquipmentData>();
            model.CurrentPage = 1;
            model.PageSize = PageSize;
            return await PrepareModel(model);
        }

        private async Task<RecipeEquipmentData> PrepareModel(RecipeEquipmentData model)
        {
            model.NumberOfRecord = await pageClient.RecipeEquipmentsCountAsync();
            model.TotalPage = (model.NumberOfRecord + PageSize - 1) / PageSize;
            model.List = (await pageClient.RecipeEquipmentsListAsync(model.CurrentPage, PageSize)).ToList();
            return model;
        }
