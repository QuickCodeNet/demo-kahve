...
namespace QuickCode.Demo - kahve . Portal . Controllers . RecipeModuleModule {
    [Permission("RecipeModuleModuleRecipes")]
    [Area("RecipeModuleModule")]
    [Route("RecipeModuleModuleRecipes")]
    public partial class RecipesController : BaseController
    {
        private readonly RecipeModuleModuleContracts.IRecipesClient pageClient;
        public RecipesController(RecipeModuleModuleContracts.IRecipesClient pageClient, IdentityModuleContracts.ITableComboboxSettingsClient tableComboboxSettingsClient, IHttpContextAccessor httpContextAccessor, IMemoryCache cache) : base(tableComboboxSettingsClient, httpContextAccessor, cache)
        {
        ...
        [Route("List")]
        [HttpPost]
        public async Task<IActionResult> List(RecipeData model)
        {
        ...
        [Route("Insert")]
        [HttpPost]
        public async Task<IActionResult> Insert(RecipeData model)
        {
            ModelBinder(ref model);
            var result = await pageClient.RecipesInsertAsync(model.SelectedItem);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Update")]
        [HttpPost]
        public async Task<IActionResult> Update(RecipeData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipesUpdateAsync(request.Id, request);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("Delete")]
        [HttpPost]
        public async Task<IActionResult> Delete(RecipeData model)
        {
            ModelBinder(ref model);
            var request = model.SelectedItem;
            var result = await pageClient.RecipesDeleteAsync(request.Id);
            ClearCache();
            SetModelBinder(ref model);
            return Ok(result);
        }
        ...
        [Route("InsertItem")]
        public IActionResult InsertItem(RecipeData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            SetModelBinder(ref model);
        ...
        [Route("DetailItem")]
        public async Task<IActionResult> DetailItem(RecipeData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("UpdateItem")]
        [HttpPost]
        public async Task<IActionResult> UpdateItem(RecipeData model)
        {
            ModelState.Clear();
            ModelBinder(ref model);
            model = await PrepareModel(model);
        ...
        [Route("DeleteItem")]
        [HttpPost]
        public async Task<IActionResult> DeleteItem(RecipeData model)
        {
            ModelBinder(ref model);
            model = await PrepareModel(model);
            model.SelectedItem = model.List.Find(i => i.GetKey() == model.SelectedKey);
        ...
        private async Task<RecipeData> PrepareModel()
        {
            var model = GetModel<RecipeData>();
            model.CurrentPage = 1;
            model.PageSize = PageSize;
            return await PrepareModel(model);
        }

        private async Task<RecipeData> PrepareModel(RecipeData model)
        {
            model.NumberOfRecord = await pageClient.RecipesCountAsync();
            model.TotalPage = (model.NumberOfRecord + PageSize - 1) / PageSize;
            model.List = (await pageClient.RecipesListAsync(model.CurrentPage, PageSize)).ToList();
            return model;
        }
    }
}