...
using QuickCode.Demo-kahve.Portal.Helpers;
using QuickCode.Demo-kahve.Portal.Helpers.Authorization;
using QuickCode.Demo-kahve.Portal.Mapper;
using QuickCode.Demo-kahve.Portal.ViewEngines;
using QuickCode.Demo-kahve.Common.Middleware;
using QuickCode.Demo-kahve.Portal.Middleware;

namespace QuickCode.Demo-kahve.Portal
{
